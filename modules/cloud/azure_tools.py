...
class AzureEnumTool(BaseTool):
    ...
    def execute(self, params: Dict[str, Any], session_id: str = None) -> Dict[str, Any]:
        ...
        result = {"success": True, "subscription": subscription, "resources": {}}
        ...
        try:
            ...
            if check.returncode != 0:
                return {"success": False, "error": "Azure CLI未登录，请运行: az login"}
            ...
            # 枚举资源
            resources_to_enum = (
                [resource_type] if resource_type != "all" else ["vm", "storage", "webapp", "sql"]
            )
